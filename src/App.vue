      ...
      <div v-if="navbarOpen">
        <main class="">
          ...
          >
            ...
            <!-- CS -->
            <div v-if="IsCS" class="fixed -mt-50 w-full p-5" data-aos="zoom-in" data-aos-duration="500">
              <div class="bg-border-100 bg-white shadow-2xl p-5 rounded-2xl">
                ...
                <form @submit.prevent class="flex flex-col gap-4">
                  ...
                  <div class="flex gap-4">
                    ...
                    <button @click="toggleKirimEmail" class="bg-blue-400 p-3 rounded-xl text-black hover:text-white hover:bg-blue-300 w-full flex items-center gap-2 text-lg">
                  ...
                  <!-- Tombol Konfirmasi Kirim Email -->
                  <button v-if="kirimViaEmail" @click="kirimEmail" class="bg-blue-500 p-3 rounded-xl text-white hover:bg-blue-600 w-full">
