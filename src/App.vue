              ...
              <div class="bg-border-100 bg-white shadow-2xl p-5 rounded-2xl">
                ...
                <form @submit.prevent class="flex flex-col gap-4">
                  ...
                  <div class="flex gap-4">
                    ...
                    <button @click="kirimEmail" class="bg-blue-400 p-3 text-center justify-center rounded-xl text-black hover:text-white hover:bg-blue-300 w-full flex items-center gap-2 text-lg">
